...
#nullable disable
    internal class ByteBankAtendimento
    {
        private List<ContaCorrente> _listaDeContas = new List<ContaCorrente>(){
            ...
            new ContaCorrente(95, "987321-W"){Saldo=60,Titular = new Cliente{Cpf="33333",Nome ="Marisa"}}
        };
        ...
        private void PesquisarContas()
        {
            ...
            Console.WriteLine("===============================");
            Console.WriteLine("\n");
            Console.Write("Deseja pesquisar por (1) NUMERO DA CONTA, (2)CPF TITULAR ou (3) Nº AGÊNCIA ? ");
