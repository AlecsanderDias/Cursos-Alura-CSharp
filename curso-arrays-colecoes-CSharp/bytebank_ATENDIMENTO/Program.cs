...
List<ContaCorrente> _listaDeContas = new List<ContaCorrente>(){
    ...
    new ContaCorrente(52, "351258-Y"){Saldo=200,Titular = new Cliente{Cpf="22222",Nome ="Pedro"}},
...
Console.WriteLine($"Nome procurado {nomeProcurado}, Resultado da procura: {EncontraNome(nomesDosEscolhidos, nomeProcurado)}");

bool EncontraNome(List<string> lista, string nome)
{
    bool encontrado = false;
    foreach (string item in lista)
    {
        if(item.ToLower() == nome.ToLower() )
        {
            encontrado = true;
